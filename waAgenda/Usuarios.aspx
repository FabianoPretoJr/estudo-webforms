...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceUsuarios" DataKeyNames="Email" InsertItemPosition="LastItem" style="width: 346px">
...
<asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Usuario]" DeleteCommand="DELETE FROM [Usuario] WHERE [Email] = @Email" InsertCommand="INSERT INTO [Usuario] ([Email], [Nome], [Senha]) VALUES (@Email, @Nome, @Senha)" UpdateCommand="UPDATE [Usuario] SET [Nome] = @Nome, [Senha] = @Senha WHERE [Email] = @Email" OnInserted="SqlDataSourceUsuarios_Inserted" OnUpdated="SqlDataSourceUsuarios_Updated">
    <DeleteParameters>
